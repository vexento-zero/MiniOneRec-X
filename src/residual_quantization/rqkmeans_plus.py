...
def parse_args():
    ...
    parser.add_argument(
        "--data_path", type=str, default="../data/Games/Games.emb-llama-td.npy"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--e_dim", type=int, default=2560, help="Must match input dim for RQ-KMeans+"
    )
    parser.add_argument(
        "--layers",
        type=int,
...
if __name__ == "__main__":
    ...
    print(
        f"RQ-KMeans+ Final Result -> Loss: {best_loss}, Collision Rate: {best_collision_rate}"
    )
